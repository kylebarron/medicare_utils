...
medicare\_utils could always use more documentation, whether as part of
the official medicare\_utils docs, in docstrings, or even on the web in
...
Ready to contribute? Here\'s how to set up medicare\_utils for local
development.

1.  Fork the medicare\_utils repo on GitHub.
