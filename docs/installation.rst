...
The sources for medicare_utils can be downloaded from the `Github repo`_.
...
.. _Github repo: https://github.com/kylebarron/medicare_utils
.. _tarball: https://github.com/kylebarron/medicare_utils/tarball/master
